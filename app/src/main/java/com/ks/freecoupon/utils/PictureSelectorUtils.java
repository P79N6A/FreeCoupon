...
public class PictureSelectorUtils {
     ...
     * @param maxTotal
     */
    public static void initMultiConfig(Activity activity, int maxTotal,int requestCode) {
...
//                .recordVideoSecond()//视频秒数录制 默认60s int
     ...
     * @param maxTotal
     */
    public static void initMultiConfig(Fragment fragment, int maxTotal, int requestCode) {
        // 进入相册 以下是例子：用不到的api可以不写
...
//                .recordVideoSecond()//视频秒数录制 默认60s int
     ...
     * @param activity
     */
    public static void initSingleConfig(Activity activity,int requestCode) {
        // 进入相册 以下是例子：用不到的api可以不写
        PictureSelector.create(activity)
                .openGallery(PictureMimeType.ofImage())//全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()
